...
tree = ET.parse('raw_data/main_boat_position/onboard_gps_source1/AI Tracks at Sea High Frequency GPS_train.txt')
root = tree.getroot()
times = list()
...
for i in range(6,23):
    ...
    with open(f"generated_data/frame2gps/frame2gps.{i}.list", "wb") as fp:   #Pickling
